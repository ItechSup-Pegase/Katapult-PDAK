...
use Sofitech\AdminBundle\Entity\Session;
use Sofitech\AdminBundle\Form\SessionType;
...
class SessionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SofitechAdminBundle:Session')->findAll();
     ...
     * @Method("POST")
     * @Template("SofitechAdminBundle:Session:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SofitechAdminBundle:Session')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SofitechAdminBundle:Session:edit.html.twig")
     */
