...
class FormationController extends Controller
{
     ...
     * @Method("POST")
     * @Template("SofitechAdminBundle:Formation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SofitechAdminBundle:Formation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SofitechAdminBundle:Formation:edit.html.twig")
     */
