...
use Sofitech\AdminBundle\Entity\Company;
use Sofitech\AdminBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SofitechAdminBundle:Company')->findAll();
     ...
     * @Method("POST")
     * @Template("SofitechAdminBundle:Company:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SofitechAdminBundle:Company')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SofitechAdminBundle:Company:edit.html.twig")
     */
