...
use Sofitech\AdminBundle\Entity\Customer;
use Sofitech\AdminBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
     ...
     * @Method("POST")
     * @Template("SofitechAdminBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SofitechAdminBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SofitechAdminBundle:Customer:edit.html.twig")
     */
